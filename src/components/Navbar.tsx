        ...
        <div className="w-full z-10 h-[50px] md:h-[70px] bg-[#EDEDED] text-[#133748] font-[Poppins] fixed shadow-lg shadow-black/10">
            <div className="w-full h-full flex justify-between px-6 md:px-10 items-center">
                ...
                <div className="hidden md:flex justify-center items-center gap-8 relative">
                    ...
                    <Link
                        to="/join"
                        className="ml-4 px-4 py-2 bg-[#133748] text-white rounded-lg hover:bg-[#0f2a36] transition duration-300"
                    >
                        Join
                    </Link>
                </div>
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        {isMobileExploreOpen && (
                            <div className="flex flex-col pl-4 text-left bg-[#f9f9f9] rounded-md shadow-md mt-2">
                                <Link to="/explore/sde" className="py-2 hover:bg-[#e2e2e2]" onClick={closeMenu}>SDE</Link>
                                <Link to="/explore/quant" className="py-2 hover:bg-[#e2e2e2]" onClick={closeMenu}>Quant</Link>
                                <Link to="/explore/core" className="py-2 hover:bg-[#e2e2e2]" onClick={closeMenu}>Core</Link>
                                <Link to="/explore/finance" className="py-2 hover:bg-[#e2e2e2]" onClick={closeMenu}>Analytics</Link>
                                <Link to="/explore/ai-ml" className="py-2 hover:bg-[#e2e2e2]" onClick={closeMenu}>AI-ML</Link>
                                <Link to="/explore/consult" className="py-2 hover:bg-[#e2e2e2]" onClick={closeMenu}>Consulting</Link>
                            </div>
                        )}
                        ...
                        {isMobileBuildOpen && (
                            <div className="flex flex-col pl-4 text-left bg-[#f9f9f9] rounded-md shadow-md mt-2">
                                <Link to="/BUILD/sde" className="py-2 hover:bg-[#e2e2e2]" onClick={closeMenu}>SDE</Link>
                                <Link to="/BUILD/quant" className="py-2 hover:bg-[#e2e2e2]" onClick={closeMenu}>Quant</Link>
                                <Link to="/BUILD/core" className="py-2 hover:bg-[#e2e2e2]" onClick={closeMenu}>Core</Link>
                                <Link to="/BUILD/finance" className="py-2 hover:bg-[#e2e2e2]" onClick={closeMenu}>Analytics</Link>
                                <Link to="/BUILD/consult" className="py-2 hover:bg-[#e2e2e2]" onClick={closeMenu}>Consulting</Link>
                            </div>
                        )}
                        ...
                        {isMobileResourcesOpen && (
                            <div className="flex flex-col pl-4 text-left bg-[#f9f9f9] rounded-md shadow-md mt-2">
                                <Link to="/Resource/UPSC" className="py-2 hover:bg-[#e2e2e2]" onClick={closeMenu}>UPSC</Link>
                                <Link to="/Resource/CAT" className="py-2 hover:bg-[#e2e2e2]" onClick={closeMenu}>CAT</Link>
                                <Link to="/Resource/Higher_Studies" className="py-2 hover:bg-[#e2e2e2]" onClick={closeMenu}>Higher Studies</Link>
                            </div>
                        )}

                        <Link to="/join" className="mt-4 py-2 px-4 bg-[#133748] text-white rounded-lg hover:bg-[#0f2a36] transition duration-300" onClick={closeMenu}>
                            Join
                        </Link>
                    </div>
                </div>
